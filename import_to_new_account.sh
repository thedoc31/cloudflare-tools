...
if [[ -f /opt/homebrew/opt/gnu-sed/libexec/gnubin/sed ]]; then
    ...
    /opt/homebrew/opt/gnu-sed/libexec/gnubin/sed -i "s/$CLOUDFLARE_OLD_ZONE_ID/$CLOUDFLARE_ZONE_ID/g" old_account_zone_config.tf
    /opt/homebrew/opt/gnu-sed/libexec/gnubin/sed -i "s/$CLOUDFLARE_OLD_ACCOUNT_ID/$CLOUDFLARE_ACCOUNT_ID/g" old_account_config.tf
    /opt/homebrew/opt/gnu-sed/libexec/gnubin/sed -i "s/$CLOUDFLARE_OLD_ACCOUNT_ID/$CLOUDFLARE_ACCOUNT_ID/g" old_account_zone_config.tf
else
